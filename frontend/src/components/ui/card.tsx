...
export const Card = ({className,...props}: React.HTMLAttributes<HTMLDivElement>) => <div className={cn("rounded-xl border border-zinc-800 bg-zinc-900/40 backdrop-blur", className)} {...props} />
