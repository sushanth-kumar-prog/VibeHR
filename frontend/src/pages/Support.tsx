    ...
    <div className="min-h-screen bg-[#FFFBF7] text-zinc-900">
      <header className="sticky top-0 z-40 border-b border-zinc-200 bg-white/80 backdrop-blur-xl">
        <div className="mx-auto max-w-[1280px] px-4 sm:px-6 h-[64px] flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2.5"><div className="h-8 w-8 rounded-lg bg-[#714B67] flex items-center justify-center font-bold text-sm text-white">DF</div><span className="font-bold">Dayflow</span><span className="text-xs text-zinc-500 ml-2 hidden sm:inline">Support</span></Link>
      ...
      <section className="mx-auto max-w-[1280px] px-4 sm:px-6 py-10">
        <div className="inline-flex items-center gap-2 rounded-full bg-white border border-zinc-200 px-3 py-1 text-xs shadow-sm"><LifeBuoy className="h-3.5 w-3.5 text-[#714B67]" /> Support</div>
        <h1 className="mt-3 text-3xl sm:text-4xl font-bold tracking-tight">Help, when you need it</h1>
        <p className="mt-3 text-sm text-zinc-600 max-w-2xl">Dayflow is built to be intuitive, but our team is always nearby. Choose the channel that works for you.</p>
        <div className="grid md:grid-cols-3 gap-4 mt-8">
          <div className="rounded-2xl border border-zinc-200 bg-white p-6">
            <MessageCircle className="h-6 w-6 text-[#714B67]" />
            <h3 className="font-semibold mt-3">Chat & Email</h3>
            <p className="text-sm text-zinc-600 mt-1">Fast, human responses — no bots.</p>
            <div className="mt-3 text-sm"><div className="flex items-center gap-2"><Mail className="h-3.5 w-3.5 text-zinc-500" /> support@dayflow.co</div><div className="text-xs text-zinc-500 mt-1 flex items-center gap-1"><Clock className="h-3 w-3" /> Avg. reply 2h 18m • Business days</div></div>
          </div>
          <div className="rounded-2xl border border-zinc-200 bg-white p-6">
            <BookOpen className="h-6 w-6 text-[#714B67]" />
            <h3 className="font-semibold mt-3">Help Center</h3>
            <p className="text-sm text-zinc-600 mt-1">Guides, FAQs, and best practices.</p>
            <Link to="/help" className="mt-3 inline-flex text-sm font-medium text-[#714B67]">Browse articles →</Link>
          </div>
          <div className="rounded-2xl border border-zinc-200 bg-white p-6">
            <Phone className="h-6 w-6 text-[#714B67]" />
            <h3 className="font-semibold mt-3">Enterprise & Sales</h3>
            <p className="text-sm text-zinc-600 mt-1">Dedicated onboarding and SLA.</p>
            <div className="mt-3 text-sm flex items-center gap-2"><Mail className="h-3.5 w-3.5 text-zinc-500" /> sales@dayflow.co</div>
          </div>
        </div>
        ...
        <div className="mt-8 grid lg:grid-cols-2 gap-6">
          <div className="rounded-2xl border border-zinc-200 bg-white p-6">
            ...
            <ul className="mt-3 space-y-2 text-sm">
              ...
              <li className="flex gap-2"><Check className="h-4 w-4 text-green-600 mt-0.5" /> Clear status updates at status.dayflow.co</li>
              <li className="flex gap-2"><Check className="h-4 w-4 text-green-600 mt-0.5" /> Prioritized help for Growth & Enterprise</li>
            </ul>
          </div>
          <div className="rounded-2xl bg-gradient-to-br from-[#714B67] to-[#8a6582] text-white p-6">
