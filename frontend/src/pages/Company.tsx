        ...
        <>
          ...
          <Card className="p-6">
            <div className="flex flex-col md:flex-row gap-6">
              <div className="h-24 w-24 rounded-2xl bg-gradient-to-br from-[#714B67] to-[#9B6B8A] flex items-center justify-center text-white shadow-md shrink-0 overflow-hidden border border-white/20">
