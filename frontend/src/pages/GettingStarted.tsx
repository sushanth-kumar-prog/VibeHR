    ...
    <div className="min-h-screen bg-[#FFFBF7] text-zinc-900">
      <header className="sticky top-0 z-40 border-b border-zinc-200 bg-white/80 backdrop-blur-xl">
        <div className="mx-auto max-w-[1280px] px-4 sm:px-6 h-[64px] flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2.5"><div className="h-8 w-8 rounded-lg bg-[#714B67] flex items-center justify-center font-bold text-sm text-white">DF</div><span className="font-bold">VibeHR</span><span className="text-xs text-zinc-500 ml-2 hidden sm:inline">Getting Started</span></Link>
      ...
      <section className="mx-auto max-w-[1280px] px-4 sm:px-6 py-10">
        ...
        <p className="mt-3 text-sm text-zinc-600 max-w-2xl">Follow this short guide. No training needed — VibeHR walks you through each step.</p>
      ...
      <section className="mx-auto max-w-[1280px] px-4 sm:px-6 pb-10">
        ...
        <div className="mt-6 rounded-2xl border border-zinc-200 bg-white p-6 flex flex-col lg:flex-row items-center gap-6">
          <div className="flex-1">
            <h3 className="font-semibold flex items-center gap-2"><Play className="h-4 w-4 text-[#714B67]" /> Watch: VibeHR in 60 seconds</h3>
            <p className="text-sm text-zinc-600 mt-1">See how leaders set up VibeHR, invite a team, and run the first payroll.</p>
