    ...
    <div className="min-h-screen bg-[#FFFBF7] text-zinc-900">
      <header className="sticky top-0 z-40 border-b border-zinc-200 bg-white/80 backdrop-blur-xl">
        <div className="mx-auto max-w-[1280px] px-4 sm:px-6 h-[64px] flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2.5"><div className="h-8 w-8 rounded-lg bg-[#714B67] flex items-center justify-center font-bold text-sm text-white">DF</div><span className="font-bold">Dayflow</span><span className="text-xs text-zinc-500 ml-2 hidden sm:inline">Getting Started</span></Link>
          <Link to="/signup"><button className="inline-flex items-center justify-center rounded-full h-8 px-5 text-sm font-medium bg-[#714B67] text-white">Start Free <ArrowRight className="ml-1.5 h-4 w-4" /></button></Link>
        </div>
      </header>

      <section className="mx-auto max-w-[1280px] px-4 sm:px-6 py-10">
        <div className="inline-flex items-center gap-2 rounded-full bg-white border border-zinc-200 px-3 py-1 text-xs shadow-sm"><BookOpen className="h-3.5 w-3.5 text-[#714B67]" /> Getting Started Guide</div>
        <h1 className="mt-3 text-3xl sm:text-4xl font-bold tracking-tight">From zero to payroll in 15 minutes</h1>
        <p className="mt-3 text-sm text-zinc-600 max-w-2xl">Follow this short guide. No training needed — Dayflow walks you through each step.</p>
      ...
      <section className="mx-auto max-w-[1280px] px-4 sm:px-6 pb-10">
          ...
          {[
            ...
            <div key={s.step} className="rounded-2xl border border-zinc-200 bg-white p-6 flex flex-col shadow-sm">
              <div className="flex items-center justify-between">
                <div className="h-10 w-10 rounded-xl bg-[#714B67] text-white flex items-center justify-center"><s.icon className="h-5 w-5" /></div>
                <span className="text-xs px-2 py-1 rounded-full bg-zinc-50 border border-zinc-200">{s.time}</span>
              </div>
              <div className="text-xs tracking-widest font-semibold text-[#714B67] mt-4">STEP {s.step}</div>
              ...
              <Link to="/signup" className="mt-4 text-sm font-medium text-[#714B67] flex items-center gap-1">{s.cta} <ArrowRight className="h-4 w-4" /></Link>
            </div>
          ))}
        </div>
        ...
        <div className="mt-6 rounded-2xl border border-zinc-200 bg-white p-6 flex flex-col lg:flex-row items-center gap-6">
          <div className="flex-1">
            <h3 className="font-semibold flex items-center gap-2"><Play className="h-4 w-4 text-[#714B67]" /> Watch: Dayflow in 60 seconds</h3>
            <p className="text-sm text-zinc-600 mt-1">See how leaders set up Dayflow, invite a team, and run the first payroll.</p>
          ...
          <div className="w-full lg:w-[360px] aspect-video rounded-xl bg-zinc-100 border border-zinc-200 flex items-center justify-center text-zinc-400">
            <div className="h-12 w-12 rounded-full bg-[#714B67] text-white flex items-center justify-center"><Play className="h-5 w-5 ml-0.5" /></div>
          </div>
        </div>

        <div className="mt-6 rounded-2xl bg-[#714B67] text-white p-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <Link to="/signup"><button className="inline-flex items-center justify-center rounded-full bg-white text-[#714B67] px-6 h-10 font-medium">Create Company — Free <ArrowRight className="ml-2 h-4 w-4" /></button></Link>
        </div>
      </section>
