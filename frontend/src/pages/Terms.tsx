    ...
    <div className="min-h-screen bg-white text-zinc-900">
      ...
      <div className="mx-auto max-w-[800px] px-4 sm:px-6 py-12">
        ...
        <div className="mt-8 space-y-6 text-sm leading-relaxed">
          <section><h2 className="font-semibold text-base">1. Agreement</h2><p className="text-zinc-600 mt-1">By creating a workspace or using VibeHR, you agree to these Terms and our Privacy Policy.</p></section>
          ...
          <section><h2 className="font-semibold text-base">4. Acceptable use</h2><p className="text-zinc-600 mt-1">Do not use VibeHR for unlawful purposes, to upload harmful content, or to attempt unauthorized access to other workspaces.</p></section>
          ...
          <section><h2 className="font-semibold text-base">7. Contact</h2><p className="text-zinc-600 mt-1">Legal: legal@vibehr.co</p></section>
        </div>
      </div>
