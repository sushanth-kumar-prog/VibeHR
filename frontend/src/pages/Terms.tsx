  ...
  return (
    <div className="min-h-screen bg-white text-zinc-900">
      ...
      <div className="mx-auto max-w-[800px] px-4 sm:px-6 py-12">
        <div className="inline-flex items-center gap-2 rounded-full bg-zinc-50 border border-zinc-200 px-3 py-1 text-xs"><FileText className="h-3.5 w-3.5 text-[#714B67]" /> Terms of Service</div>
        ...
        <div className="mt-8 space-y-6 text-sm leading-relaxed">
          <section><h2 className="font-semibold text-base">1. Agreement</h2><p className="text-zinc-600 mt-1">By creating a workspace or using Dayflow, you agree to these Terms and our Privacy Policy.</p></section>
          ...
          <section><h2 className="font-semibold text-base">4. Acceptable use</h2><p className="text-zinc-600 mt-1">Do not use Dayflow for unlawful purposes, to upload harmful content, or to attempt unauthorized access to other workspaces.</p></section>
          ...
          <section><h2 className="font-semibold text-base">7. Contact</h2><p className="text-zinc-600 mt-1">Legal: legal@dayflow.co</p></section>
        </div>
      </div>
