...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-[#FFFBF7] text-zinc-900 selection:bg-[#714B67]/15">
      ...
      <section className="relative overflow-hidden bg-[#FFFBF7]">
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          ...
          <div className="absolute inset-0 opacity-[0.035] bg-[radial-gradient(#714B67_1px,transparent_1px)] [background-size:18px_18px]" />
        </div>
          ...
          <div className="grid lg:grid-cols-[1.05fr_0.95fr] gap-10 lg:gap-8 items-center">
            ...
            <div className="space-y-6 relative">
              ...
              <div className="flex flex-wrap gap-3">
                <Link to="/signup">
                  <button className="inline-flex items-center justify-center rounded-lg px-6 h-11 text-[14px] font-semibold bg-[#6B3A5D] text-white hover:bg-[#5f4057] shadow-[0_4px_20px_rgba(107,58,93,0.3)]">
            ...
            <div className="relative lg:pl-4">
              <div className="relative rounded-[28px] border border-zinc-200/80 bg-white p-3 sm:p-4 shadow-[0_24px_64px_rgba(23,23,23,0.08),0_8px_24px_rgba(23,23,23,0.06)] overflow-hidden">
                ...
                <div className="relative flex items-center justify-between px-1.5 py-1">
                  ...
                  <div className="h-7 w-7 rounded-full bg-gradient-to-br from-[#6B3A5D] to-[#9d6f94] flex items-center justify-center text-[10px] font-bold text-white shadow-sm ring-1 ring-white">OS</div>
                </div>
                ...
                {/* payroll bar */}
                <div className="relative mt-3 rounded-[16px] bg-gradient-to-r from-[#6B3A5D] via-[#7a4a6e] to-[#9d6f94] p-[1px] shadow-[0_8px_24px_rgba(107,58,93,0.22)]">
                  <div className="rounded-[15px] bg-gradient-to-r from-[#6B3A5D] to-[#8a6582] px-4 py-3 flex items-center justify-between text-white">
              ...
              <div className="hidden sm:flex absolute -right-5 -top-1 rounded-[14px] border border-zinc-200 bg-white/95 backdrop-blur pl-2 pr-3.5 py-2.5 shadow-[0_16px_40px_rgba(0,0,0,0.12)] items-center gap-3">
                <div className="h-9 w-9 rounded-full bg-[#6B3A5D] flex items-center justify-center text-white shadow-sm"><CalendarCheck className="h-4.5 w-4.5" /></div>
                <div>
      ...
      <section id="how-it-works" className="relative overflow-hidden border-y border-zinc-200 bg-[#FFFBF7]">
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          ...
          <div className="absolute inset-0 opacity-[0.02] bg-[radial-gradient(#714B67_1px,transparent_1px)] [background-size:20px_20px]" />
        </div>
        <div className="relative mx-auto max-w-[1280px] px-4 sm:px-6 py-16 sm:py-20">
      ...
      <section id="roles" className="relative overflow-hidden bg-white">
        ...
        <div className="grid md:grid-cols-3 gap-5 mt-10">
          {[
            { role: 'Company Admin', badge: 'Full access', icon: ShieldCheck, color: 'from-[#714B67] to-[#8a6582]', items: ['Full team overview & invite anyone', 'Manage company settings & branding', 'View attendance and run payroll', 'Approve time off & manage salaries'] },
      ...
      <section className="relative overflow-hidden bg-[#FFFBF7] px-4 sm:px-6 py-10">
        ...
        <div className="relative mx-auto max-w-[1280px] rounded-[24px] border border-[#714B67]/15 bg-gradient-to-br from-[#714B67] via-[#7a5771] to-[#8a6582] p-[1px]">
