      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent>
          <form onSubmit={submit} className="space-y-3">
            ...
            <div className="text-xs text-zinc-500">Password rules: 8+ chars, uppercase, lowercase, number, special char. Email verification required — token sent after signup (mock).</div>
