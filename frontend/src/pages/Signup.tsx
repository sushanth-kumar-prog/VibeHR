    ...
    <div className="min-h-screen lg:h-screen lg:overflow-hidden flex flex-col lg:flex-row bg-white dark:bg-zinc-950">
      ...
      <div className="hidden lg:flex lg:w-[52%] relative overflow-hidden bg-[#3d1f36] text-white flex-col shrink-0">
        ...
        <div className="relative z-10 flex flex-col h-full px-10 xl:px-12 py-8">
          <Link to="/" className="flex items-center gap-3 shrink-0">
            <img src="/logo.svg" alt="VibeHR logo" className="h-9 w-9 rounded-xl" />
            <span className="font-bold text-xl tracking-tight">VibeHR</span>
          </Link>
          ...
          <div className="mt-6 shrink-0 flex items-center justify-between text-xs text-white/50 pt-5 border-t border-white/10">
            <span>© 2026 VibeHR Technologies</span>
      ...
      {/* Right — 50% Side Panel Card - no outer space */}
        ...
        <div className="lg:hidden h-12 border-b border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 flex items-center justify-between px-4 shrink-0">
          <Link to="/" className="flex items-center gap-2 font-bold text-sm"><img src="/logo.svg" alt="VibeHR logo" className="h-6 w-6 rounded-lg" /> VibeHR</Link>
            ...
            {step===0 && (
              <div className="space-y-5">
                ...
                <div className="space-y-2">
                  ...
                  <div className={`border border-dashed rounded-lg p-3.5 flex items-center gap-4 ${form.logoPreview ? 'border-[#714B67]/30 bg-[#714B67]/5' : 'border-zinc-200 dark:border-zinc-700'}`}>
                    ...
                    <div className="flex-1 min-w-0 text-left">
                      ...
                      <div className="mt-2 flex gap-2">
                        <label className="inline-flex items-center gap-1.5 h-8 px-3 rounded-md bg-[#714B67] text-white text-xs font-medium cursor-pointer hover:bg-[#5d3d55] transition-colors">
            ...
            {step===1 && (
              <div className="space-y-5">
                ...
                <div className="border-t border-zinc-200 dark:border-zinc-800 pt-4 flex gap-3 items-center">
                  <div className="h-9 w-9 rounded-full bg-[#714B67] text-white flex items-center justify-center font-bold text-xs shrink-0">{(form.firstName[0]||'A')}{(form.lastName[0]||'A')}</div>
            ...
            {step===2 && (
              <div className="space-y-5">
                ...
                <div className="border-t border-zinc-200 dark:border-zinc-800 pt-4 space-y-2">
                  <div className="text-sm font-semibold flex items-center gap-1.5"><Users className="h-4 w-4 text-[#714B67]" /> Review</div>
