    ...
    <div className="space-y-6">
      ...
      <div className="grid lg:grid-cols-3 gap-4">
        ...
        <Card className="p-5">
          ...
          {employees.length>6 && <Link to="/dashboard" className="mt-3 block text-center text-xs text-violet-600 dark:text-violet-400 hover:underline">{employees.length-6} more employees →</Link>}
        </Card>
      </div>
      ...
      <div>
        <div className="flex items-center justify-between">
          ...
          <span className="text-xs text-zinc-500">Click card for profile • dots = today attendance</span>
        </div>
