...
const faqs = [
  ...
  {q:'Can I customize payroll components?', a:'Yes. Add earnings and deductions, set formulas, and VibeHR calculates accurate breakdowns for each person.'},
]
    ...
    <div className="min-h-screen bg-[#FFFBF7] text-zinc-900">
      <header className="sticky top-0 z-40 border-b border-zinc-200 bg-white/80 backdrop-blur-xl">
        <div className="mx-auto max-w-[1280px] px-4 sm:px-6 h-[64px] flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2.5"><div className="h-8 w-8 rounded-lg bg-[#714B67] flex items-center justify-center font-bold text-sm text-white">DF</div><span className="font-bold">VibeHR</span><span className="text-xs text-zinc-500 ml-1 hidden sm:inline">Help Center</span></Link>
      ...
      <section className="relative overflow-hidden border-b border-zinc-200 bg-gradient-to-br from-[#714B67] via-[#7a5771] to-[#8a6582] text-white">
        ...
        <div className="relative mx-auto max-w-[720px] px-4 sm:px-6 py-12 text-center">
          ...
          <p className="mt-3 text-sm text-white/80">Search guides, tutorials, and best practices from the VibeHR team.</p>
