    ...
    <div className="min-h-screen bg-[#FFFBF7] text-zinc-900 selection:bg-[#714B67]/15">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-[1280px] px-4 sm:px-6 py-16 sm:py-20">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 rounded-full bg-white border border-zinc-200 px-3 py-1 text-xs text-zinc-600 shadow-sm"><Building2 className="h-3.5 w-3.5 text-[#714B67]" /> About VibeHR</div>
            ...
            <p className="mt-4 text-[16px] leading-relaxed text-zinc-600 max-w-[640px]">VibeHR was built for leaders who believe HR should be clear, calm, and confident. We help growing teams manage people, time, and pay — without complexity.</p>
          </div>
      ...
      <section className="mx-auto max-w-[1280px] px-4 sm:px-6 pb-16">
        <div className="rounded-2xl border border-zinc-200 bg-white p-8">
          ...
          <p className="mt-3 text-sm leading-relaxed text-zinc-600 max-w-3xl">Founded in Bengaluru in 2024, VibeHR began as a simple idea: HR software should feel like a calm, well-run office — not a maze of spreadsheets. Today we support 2,400+ teams who run attendance, leave and payroll on VibeHR every day. We’re a small team obsessed with reliability, privacy, and craft.</p>
      ...
      <footer className="border-t border-zinc-200 bg-white">
        <div className="mx-auto max-w-[1280px] px-4 sm:px-6 py-8 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-zinc-500">
          <span>© 2026 VibeHR Technologies Pvt. Ltd.</span>
