    ...
    <div className="min-h-screen bg-[#FFFBF7] text-zinc-900 selection:bg-[#714B67]/15">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-[1280px] px-4 sm:px-6 py-16 sm:py-20">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 rounded-full bg-white border border-zinc-200 px-3 py-1 text-xs text-zinc-600 shadow-sm"><Building2 className="h-3.5 w-3.5 text-[#714B67]" /> About Dayflow</div>
            <h1 className="mt-4 text-[36px] sm:text-[46px] font-bold tracking-tight leading-[0.95] text-zinc-900">People operations,<br/><span className="text-[#8B5A7A]">perfectly aligned.</span></h1>
            <p className="mt-4 text-[16px] leading-relaxed text-zinc-600 max-w-[640px]">Dayflow was built for leaders who believe HR should be clear, calm, and confident. We help growing teams manage people, time, and pay — without complexity.</p>
          </div>
          <div className="grid md:grid-cols-3 gap-5 mt-10">
            {[
              ...
              <div key={c.title} className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm">
                <div className="h-10 w-10 rounded-xl bg-[#714B67]/10 flex items-center justify-center"><c.icon className="h-5 w-5 text-[#714B67]" /></div>
      ...
      <section className="mx-auto max-w-[1280px] px-4 sm:px-6 pb-16">
        <div className="rounded-2xl border border-zinc-200 bg-white p-8">
          <div className="flex items-center gap-2 text-xs font-semibold tracking-[0.12em] text-[#714B67]"><Sparkles className="h-3.5 w-3.5" /> OUR STORY</div>
          <p className="mt-3 text-sm leading-relaxed text-zinc-600 max-w-3xl">Founded in Bengaluru in 2024, Dayflow began as a simple idea: HR software should feel like a calm, well-run office — not a maze of spreadsheets. Today we support 2,400+ teams who run attendance, leave and payroll on Dayflow every day. We’re a small team obsessed with reliability, privacy, and craft.</p>
      ...
      <footer className="border-t border-zinc-200 bg-white">
        <div className="mx-auto max-w-[1280px] px-4 sm:px-6 py-8 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-zinc-500">
          <span>© 2026 Dayflow Technologies Pvt. Ltd.</span>
