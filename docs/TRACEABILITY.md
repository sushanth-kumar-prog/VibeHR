# Dayflow — Traceability: 2 References → Implementation

> References: `Dayflow - Human Resource Management System.pdf` + `image.png` (Excalidraw wireframes, link https://link.excalidraw.com/l/65VNwvy7c4X/58RLEJ4oOwh)
...
- `fastapi.testclient: root {'message':'Dayflow API running'} health {'status':'ok'} paths 43` ✅
